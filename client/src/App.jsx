...
export default function App() {
  ...
  const start = (selection) => { setInterests(selection || { interests: [], gender: '', preferredGender: 'any' }); setInChat(true); };
  return (
    <div className={`app ${inChat ? 'chat-active' : 'landing-active'}`}>
      ...
      {!inChat ? <LandingPage onStart={start} online={online} /> : <VideoChat socket={socket} {...interests} onLeave={() => setInChat(false)} />}
